...
|---|---|---|---|
| **01** | [Virtual vehicle: three ECUs on a bus](01-virtual-vehicle/) | You can write a DBC, encode Motorola by hand, compute bus load, protect a frame with E2E | ✅ 20 tests, six injectable faults |
